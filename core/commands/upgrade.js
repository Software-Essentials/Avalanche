...
function upgrade() {
    ...
    const animation = setInterval(() => {
      ...
      process.stdout.write(`${CoreUtil.terminalPrefix()}\x1b[32m Upgrading Avalanche project ${dots}\x1b[0m`)
    ...
    iProcess.on("exit", (code, signal) => {
      ...
      process.stdout.write(`\n${CoreUtil.terminalPrefix()}\x1b[32m Avalanche project has been upgraded to the latest stable version (${currentVersion}).\n\x1b[0m`);
      ready();
    });
}
